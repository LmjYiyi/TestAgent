...
| ├─ card_pin_chk_flag|string|否|1|卡密码检查标志，0-不检查，1-检查|0|
| ├─ card_pin|string|否|6|卡密码||
| ├─ card_expired_flag|string|否|1|卡有效期检查标志，0-不检查，1-检查|0|
| ├─ card_expired_date|string|否|6|卡片有效期||
...
| ├─ cer_chk|string|否|1|证件检查标志，0-不检查，1-检查|0|
| ├─ cer_type|string|否|3|证件类型，0-身份证，1-护照，3-港澳台通行证||
| └─ cer_no|string|否|20|证件号码||
